(function() {
  'use strict';
  angular.module('module.controller.customer', [])
    .controller('controller.customer', customerCtrl); 
   ...
   function customerCtrl($scope, $resourceService, $state, $mdDialog, $mdMedia) {
